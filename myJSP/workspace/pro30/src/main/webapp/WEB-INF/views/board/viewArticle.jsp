	...
	<form name="frmArticle" method="POST" action="${contextPath}"
		...
		<table border="0" align="center">
			...
			<tr>
				...
				<td><textarea name="content" id="i_content" cols="60" rows="20"
				...
				<c:when test="${not empty article.imageFileName && article.imageFileName !='null'}">
					<tr>
						...
						<td>
							...
							<img src="${contextPath}/download.do?articleNO=${article.articleNO}&imageFileName=${article.imageFileName}"id="priview" /><br>
						</td>
					</tr>
					<tr>
						<td>
